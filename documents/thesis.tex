ge\documentclass[a4paper, oneside]{article}
\usepackage{array}
\usepackage{shortvrb}
\usepackage{listings}
\usepackage{fullpage}
...
\color{red}Talk about evaluation metrics (mainly MOS)? 50 features? Arpabet? Remove last segment on linguistic contexts?\color{black}
...
\color{red}
Skipping the following, in order:

Tacotron, Deep voice 2, Deep voice 3

I'll see later whether or not I should read and include them
\color{black}
