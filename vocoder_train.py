...
This module uses the synthesizer audios and the GTA synthesized
mel spectrograms/ground truth mel spectrograms to train the vocoder.
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Trains vocoder from synthesizer audios, GTA synthesized mels, or ground truth mels.",
