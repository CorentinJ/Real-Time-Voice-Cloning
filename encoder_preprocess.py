...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--datasets", type=str,
                        default="librispeech_other,voxceleb1,voxceleb2", help="Comma-separated list of the name of the datasets you want to preprocess. Only the train "
                        "set of these datasets will be used. Possible names: librispeech_other, voxceleb1, "
                        "voxceleb2.")
    parser.add_argument("-s", "--skip_existing", action="store_false", help="Whether to skip existing output files with the same name. Useful if this script was "
                        "interrupted.")
