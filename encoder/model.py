...
Handles the speaker encoder initialisation and its
main functions.
"""
...
class SpeakerEncoder(nn.Module):
    ...
    def forward(self, utterances, hidden_init=None):
        ...
        # Pass the input through LSTM layers and retrieve all outputs, the final hidden state
        # and the final cell state.
        out, (hidden, cell) = self.lstm(utterances, hidden_init)

        # Taking only the hidden state of the last layer
