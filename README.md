...
**If you want to supply your own audio**, you can simply add the directory `UserAudio` to your `datasets_root` directory, and put all the audio files in a speaker folder; such that it looks like `<datasets_root>/UserAudio/speaker_01`. The next time you run the toolbox, the files will automatically be browsable.
