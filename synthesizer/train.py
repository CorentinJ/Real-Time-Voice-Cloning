...
def train(run_id: str, syn_dir: str, models_dir: str, save_every: int,
    ...
    for i, session in enumerate(hparams.tts_schedule):
        ...
        for epoch in range(1, epochs+1):
            for i, (texts, mels, embeds, idx, text_lengths, gate_padded, mel_lengths, max_mel_length) in enumerate(data_loader, 1):
                ...
                if device.type == "cuda" and torch.cuda.device_count() > 1:
                    ...
                    m1_hat, m2_hat, attention = model(
                        texts, text_lengths, mels, max_mel_length, mel_lengths, embeds)
                ...
                epoch_eval = hparams.tts_eval_interval == - \
                    1 and i == steps_per_epoch  # If epoch is done
...
def eval_model(attention, mel_prediction, target_spectrogram, input_seq, step,
    ...
    attention_path = str(plot_dir.joinpath(
