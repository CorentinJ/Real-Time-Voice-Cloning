...
class TestConfigEn(object):
    # device = cpu
    device = cpu
    encoder_model_path = f'synthesizer/models/tacotron/utils/g2p/models/{DataConfigEn.language}/encoder_e{TrainConfigEn.epochs:02}.pth'
    decoder_model_path = f'synthesizer/models/tacotron/utils/g2p/models/{DataConfigEn.language}/decoder_e{TrainConfigEn.epochs:02}.pth'

class TestConfigRu(object):
    # device = cpu
    device = cpu
    encoder_model_path = f'synthesizer/models/tacotron/utils/g2p/models/{DataConfigRu.language}/encoder_e{TrainConfigRu.epochs:02}.pth'
    decoder_model_path = f'synthesizer/models/tacotron/utils/g2p/models/{DataConfigRu.language}/decoder_e{TrainConfigRu.epochs:02}.pth'
