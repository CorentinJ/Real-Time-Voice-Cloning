"""
Synthesizer Preprocess Audio
============================

Preprocesses the audio files from datasets to then encode them
as mel spectrograms and write them to the disk.
Audio files are saved, too and later used by the vocoder for
training.
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Preprocesses audio files from datasets, encoding them as mel spectrograms "
        "and writing them to disk. Audio files are also saved to be used by the "
    ...
    # Verify, that webrtcvad is available
    if not args.no_trim:
        try:
            import webrtcvad
        except:
