...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--n_processes", type=int, default=6, help="Number of processes in parallel.")
    parser.add_argument("-s", "--skip_existing", action="store_true", default="True",
                        help="Whether to overwrite existing files with the same name. Useful if the preprocessing was "
                             "interrupted.")
    parser.add_argument("--hparams", type=str, default="",
                        help="Hyperparameter overrides as a comma-separated list of name-value pairs")
    parser.add_argument("--no_alignments", action="store_true", help="Use this option when dataset does not include "
                                                                     "alignments(these are used to split long audio "
                                                                     "files into sub-utterances.)")
    parser.add_argument("--datasets_name", type=str, default="LibriSpeech", help="Name of the dataset "
